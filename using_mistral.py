...
def get_conversational_chain():
    prompt_template = """answer the question on the basis of context provided 
    {context}
    {question}
    Don't Write the context in the output.
"""
    # model = ChatGoogleGenerativeAI(model="gemini-pro", temperature=0)
    model = HuggingFaceHub(repo_id="mistralai/Mistral-7B-v0.1",model_kwargs={"temperature":0.1 , "max_length":1000})
