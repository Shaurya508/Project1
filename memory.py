...
# Chatbot:"""
    ...
    if question is asking for code always give link from which code is extracted and if it is not about code then always give link like " arymalabs.substack.com " .
    Context:\n{context}?\n
